                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" name="id_post_category" id="id_post_category">
                                <input type="text" name="title" id="title" class="form-control" placeholder="Post Category" autofocus required>
                            </div>
                        </div>
                        <div class="form-group">
